...
var style_City_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 0;
    var placement = 'point';
    if (feature.get("wikipedia") !== null) {
        labelText = String(feature.get("wikipedia"));
    }
    var style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 9.999999999999996 + size,
